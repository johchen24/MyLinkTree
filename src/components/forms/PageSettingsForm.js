        ...
        <div>
            <SectionBox>
                <form action={saveBaseSettings}>
                    <div className="bg-gray-300 -m-4 min-h-[300px] flex justify-center items-center flex-col mb-8 bg-cover bg-center" style={bgType === 'image' ? {backgroundImage: `url(${bgImage})`} : {backgroundColor: bgColor}}>
                    ...
                    <div className="p-4 styled">
                        ...
                        <input type="text" name="displayName" className="focus:outline-none focus:ring-1 focus:border-emerald-800/60" defaultValue={page.displayName} id="nameIn" placeholder="John Doe"/>
                        <label htmlFor="locationIn" className="input-label">Location</label>
                        <input type="text" name="location" className="focus:outline-none focus:ring-1 focus:border-emerald-800/60" defaultValue={page.location} id="locationIn" placeholder="New York, NY"/>
                        <label htmlFor="bioIn" className="input-label">Bio</label>
                        <textarea name="bio" className="focus:outline-none focus:ring-1 focus:border-emerald-800/60" defaultValue={page.bio} id="bioIn" placeholder="Your Bio..."/>
